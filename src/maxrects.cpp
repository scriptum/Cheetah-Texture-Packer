            ...
            switch(heuristic)
            {
                ...
                case ImagePacker::TL:
                    ...
                    for(int k = 0; k < R.size(); k++)
                    {
                        ...
                        {
                            if(R.at(k).x() + R.at(k).width() == F.at(i).r.x()){m -= 5; _leftNeighbor = true;}
                            if(R.at(k).x() == F.at(i).r.x() + F.at(i).r.width()){m -=5; _rightNeighbor = true;}
                        }
                    }
                    if(_leftNeighbor || _rightNeighbor == false)
                    {
                        if(F.at(i).r.x() + F.at(i).r.width() == w){m -= 1; _rightNeighbor = true;}
                        if(F.at(i).r.x() == 0){m -= 1; _leftNeighbor = true;}
                    }
                    break;
